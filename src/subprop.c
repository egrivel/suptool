...
void subprop_reset() {
  gl_subprop_base_height = 0;
  gl_subprop_asc_height = 0;
  gl_subprop_desc_height = 0;
  gl_subprop_normal_space_width = 7;
  gl_subprop_normal_space_override = false;
  gl_subprop_italic_space_width = 5;
  gl_subprop_italic_space_override = false;
  gl_subprop_base_width = 0;
}
